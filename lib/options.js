...
const optionatorInstance = optionator({
...
// Attach options array to the instance (matching original behavior)
optionatorInstance.options = options;

module.exports = optionatorInstance;
